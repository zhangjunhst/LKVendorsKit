...
@property (nonatomic,strong) UIColor *selectedTextColor;//被选中的标签字体颜色
@property (nonatomic,strong) UIColor *keyColor;//搜索关键词颜色
@property (nonatomic,assign) CGFloat tagSpace;//标签内部左右间距(标题距离边框2边的距离和)
@property (nonatomic,assign) CGFloat tagHeight;//标签高度
@property (nonatomic,assign) CGFloat tagMinWidth;//标签文字最小宽度 (不含tagSpace)
