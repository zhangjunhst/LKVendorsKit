...
- (void)swipeableView:(ZLSwipeableView *)swipeableView
         didEndSwipeView:(UIView *)view
            direction:(UISwipeGestureRecognizerDirection)direction;


- (void)swipeableView:(ZLSwipeableView *)swipeableView
         didEndRewindView:(UIView *)view;


- (void)swipeableView:(ZLSwipeableView *)swipeableView
           didEndRemoveView:(UIView *)view;

- (void)swipeableViewDidEndUpdateViews:(ZLSwipeableView *)swipeableView;
